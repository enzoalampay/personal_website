...
<svg width="400" height="100">
        ...
        <circle class="timeline-event" r="10" cy="50" cx="62"></circle>
        <circle class="timeline-event" r="10" cy="50" cx="90"></circle>
        <circle class="timeline-event" r="10" cy="50" cx="268"></circle>
        <circle class="timeline-event" r="10" cy="50" cx="300"></circle>
