...
function Timeline(){
  ...
  const [timelineCard, setTimelineCard] = useState(["Hover over an event to see what I've done"]);
...
<svg width="400" height="100">
        ...
        <circle onMouseOver={handleHover} onMouseOut={handleMouseOut} id="event-1" class="timeline-event" r="10" cy="50" cx="62"></circle>
        <circle onMouseOver={handleHover} onMouseOut={handleMouseOut} id="event-2" class="timeline-event" r="10" cy="50" cx="90"></circle>
        <circle onMouseOver={handleHover} onMouseOut={handleMouseOut} id="event-3" class="timeline-event" r="10" cy="50" cx="268"></circle>
        <circle onMouseOver={handleHover} onMouseOut={handleMouseOut} id="event-4" class="timeline-event" r="10" cy="50" cx="300"></circle>
        <circle class="timeline-end" r="10" cy="50" cx="388"></circle>
  
        <text x="6.3984375" y="80" class="timeline-text">2017</text>
        <text x="375" y="80"  class="timeline-text">2021</text>
      </svg>
