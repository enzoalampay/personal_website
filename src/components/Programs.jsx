      ...
      <h2>What I know how to use</h2>
          <div class="container applications">
            ...
            <div class="programming-icons">
              <i onMouseEnter={displayName} id="CSS"class="fab fa-css3-alt fa-4x"></i>
              <i onMouseEnter={displayName} id="HTML5"class="fab fa-html5 fa-4x"></i>
              <i onMouseEnter={displayName} id="Javascript"class="fab fa-js fa-4x"></i>
              <i onMouseEnter={displayName} id="React"class="fab fa-react fa-4x"></i>
              <i onMouseEnter={displayName} id="Bootstrap"class="fab fa-bootstrap fa-4x"></i>
              <i onMouseEnter={displayName} id="Node.js"class="fab fa-node-js fa-4x"></i>
